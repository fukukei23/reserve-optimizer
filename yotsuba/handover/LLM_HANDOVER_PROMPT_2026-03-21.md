...
- **Tailscale導入**（2026-03-21完了）
  - よつばIP: `100.78.104.58` / Windowsノード: `100.123.21.28`
  - Wi-Fi内・テザリング両環境でSSH接続確認済み
  - キー有効期限: 2026-09-16（期限後に再認証が必要）
  - 詳細: README_HANDOVER.md セクション21参照
...
3. **Wi-Fiチップ不安定**（中）: ath10k_pci AERエラー
   ...
   - 温度センサー（75℃表示）はath10kチップの値でCPU実温度（34-35℃）は正常
