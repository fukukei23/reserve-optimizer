...
assert('AWAITING_REVIEW_RATING defined', USER_STATES.AWAITING_REVIEW_RATING === 'AWAITING_REVIEW_RATING');
assert('AWAITING_KARTE_SELECT defined', USER_STATES.AWAITING_KARTE_SELECT === 'AWAITING_KARTE_SELECT');
assert('AWAITING_KARTE_INPUT defined', USER_STATES.AWAITING_KARTE_INPUT === 'AWAITING_KARTE_INPUT');
assert('22 states total', Object.keys(USER_STATES).length === 22);
